...
enum vtcm_general_type
{
	    ...
	    DTYPE_VTCM_IN_CAP=0x2011,
	    DTYPE_VTCM_IN_KEY=0x2012,
    	DTYPE_VTCM_NV=0x2013,
    	DTYPE_VTCM_PCR=0x2014,
    	DTYPE_VTCM_AUTH=0x2015,
        DTYPE_VTCM_KEY=0x2016,
	    DTYPE_VTCM_IDENTITY=0x2017,
	    DTYPE_VTCM_SEAL=0x2018
...
enum subtype_vtcm_key_struct
{
    ...
    SUBTYPE_TCM_BIN_PUBKEY=0x02,
    SUBTYPE_TCM_BIN_STORE_PUBKEY=0x03,
    SUBTYPE_TCM_BIN_RSA_KEY_PARMS=0x04,
    SUBTYPE_TCM_BIN_SM2_ASYMKEY_PARAMETERS=0x05,
    SUBTYPE_TCM_BIN_SYMMETRIC_KEY_PARMS=0x06,
    SUBTYPE_TCM_BIN_KEY=0x07,
    SUBTYPE_TCM_BIN_STORE_ASYMKEY=0x08,
    SUBTYPE_TCM_BIN_STORE_SYMKEY=0x09,
    SUBTYPE_TCM_BIN_STORE_PRIVKEY=0x0A
};
